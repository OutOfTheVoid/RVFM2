...
use crate::{interrupt_controller::INTERRUPT_CONTROLLER, hart_clock::HART_CLOCK_MASTER};
...
impl SharedCSRs {
    ...
    pub fn w(&self, csr: u16, val: u32) -> CsrWriteResult {
        Err(())
    }

    pub fn rw(&self, csr: u16, val: u32) -> CsrReadWriteResult {
        Err(())
    }

    pub fn rs(&self, csr: u16, val: u32) -> CsrReadWriteResult {
        Err(())
    }

    pub fn rc(&self, csr: u16, val: u32) -> CsrReadWriteResult {
        Err(())
    }
}
