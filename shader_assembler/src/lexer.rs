            ...
            'a' ..= 'z' | 'A' ..= 'Z' | '_' => {
                ...
                let t = if value_string.to_lowercase().starts_with("vloc_") {
                    ...
                    match value_string.to_lowercase().as_str() {
                        ...
                        "ineg"             => TokenType::Instruction(InstructionType::Neg(OpDataType::I32)),
                        "fneg"             => TokenType::Instruction(InstructionType::Neg(OpDataType::F32)),
                        "fsign"            => TokenType::Instruction(InstructionType::Sign(OpDataType::F32)),
                        "isign"            => TokenType::Instruction(InstructionType::Sign(OpDataType::I32)),
                        ...
                        "fadd"             => TokenType::Instruction(InstructionType::Add(OpDataType::F32)),
                        "fsub"             => TokenType::Instruction(InstructionType::Sub(OpDataType::F32)),
                        "fmul"             => TokenType::Instruction(InstructionType::Mul(OpDataType::F32)),
                        "fdiv"             => TokenType::Instruction(InstructionType::Div(OpDataType::F32)),
                        "fmod"             => TokenType::Instruction(InstructionType::Mod(OpDataType::F32)),
                        "iadd"             => TokenType::Instruction(InstructionType::Add(OpDataType::I32)),
                        "isub"             => TokenType::Instruction(InstructionType::Sub(OpDataType::I32)),
                        "imul"             => TokenType::Instruction(InstructionType::Mul(OpDataType::I32)),
                        "idiv"             => TokenType::Instruction(InstructionType::Div(OpDataType::I32)),
                        "imod"             => TokenType::Instruction(InstructionType::Mod(OpDataType::I32)),
                        ...
                        "ffma"             => TokenType::Instruction(InstructionType::Fma(OpDataType::F32)),
                        "ifma"             => TokenType::Instruction(InstructionType::Fma(OpDataType::I32)),
