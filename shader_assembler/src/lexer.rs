...
pub enum InstructionType {
    ...
    CMov,
    Read(BufferDataType),
    Write(BufferDataType),
    CRead,
    CWrite,
    Load(TextureOpType, OpDataType),
    Store,
    ConvertF32ToI32,
    ConvertF32ToU32,
    ConvertU32ToF32,
            ...
            'a' ..= 'z' | 'A' ..= 'Z' | '_' => {
                ...
                let (t, accepts_component, clear_component) = if register_string.to_lowercase().starts_with("vloc_") {
                    ...
                    match value_string.to_lowercase().as_str() {
                        ...
                        "read.f32"         => (TokenType::Instruction(InstructionType::Read(BufferDataType::F32)), false, true),
                        "read.u32"         => (TokenType::Instruction(InstructionType::Read(BufferDataType::U32)), false, true),
                        "read.u16"         => (TokenType::Instruction(InstructionType::Read(BufferDataType::U16)), false, true),
                        "read.u8"          => (TokenType::Instruction(InstructionType::Read(BufferDataType::U8)), false, true),
                        "read.i32"         => (TokenType::Instruction(InstructionType::Read(BufferDataType::I32)), false, true),
                        "read.i16"         => (TokenType::Instruction(InstructionType::Read(BufferDataType::I16)), false, true),
                        "read.i8"          => (TokenType::Instruction(InstructionType::Read(BufferDataType::I8)), false, true),
                        "read.inorm32"     => (TokenType::Instruction(InstructionType::Read(BufferDataType::INorm32)), false, true),
                        "read.inorm16"     => (TokenType::Instruction(InstructionType::Read(BufferDataType::INorm16)), false, true),
                        "read.inorm8"      => (TokenType::Instruction(InstructionType::Read(BufferDataType::INorm8)), false, true),
                        "read.unorm32"     => (TokenType::Instruction(InstructionType::Read(BufferDataType::UNorm32)), false, true),
                        "read.unorm16"     => (TokenType::Instruction(InstructionType::Read(BufferDataType::UNorm16)), false, true),
                        "read.unorm8"      => (TokenType::Instruction(InstructionType::Read(BufferDataType::UNorm8)), false, true),
                        ...
                        "conv.i.f"         => (TokenType::Instruction(InstructionType::ConvertF32ToI32), false, true),
                        "conv.u.f"         => (TokenType::Instruction(InstructionType::ConvertF32ToU32), false, true),
                        "conv.f.i"         => (TokenType::Instruction(InstructionType::ConvertI32ToF32), false, true),
                        "conv.f.u"         => (TokenType::Instruction(InstructionType::ConvertU32ToF32), false, true),
                        ...
                        "fma.f"            => (TokenType::Instruction(InstructionType::Fma(OpDataType::F32)), false, false),
                        "fma.i"            => (TokenType::Instruction(InstructionType::Fma(OpDataType::I32)), false, false),
                        "lerp"             => (TokenType::Instruction(InstructionType::Lerp), false, false),
                        "norm.v2"          => (TokenType::Instruction(InstructionType::Norm2), false, true),
                        "norm.v3"          => (TokenType::Instruction(InstructionType::Norm3), false, true),
                        "norm.v4"          => (TokenType::Instruction(InstructionType::Norm4), false, true),
                        ...
                        "magsq.v2"         => (TokenType::Instruction(InstructionType::SqMag2), false, true),
                        "magsq.v3"         => (TokenType::Instruction(InstructionType::SqMag3), false, true),
                        "magsq.v4"         => (TokenType::Instruction(InstructionType::SqMag4), false, true),
