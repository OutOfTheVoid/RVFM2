...
volatile usize * const COMMANDLIST_SUBMISSION_PORT = (((volatile usize *) 0x80010000));
...
static inline void submit_commandlist(CommandList command_list, volatile u32 * completion_flag) {
    *completion_flag = 0;
    command_list->completion_flag = completion_flag;
    *COMMANDLIST_SUBMISSION_PORT = (usize) command_list;
}
